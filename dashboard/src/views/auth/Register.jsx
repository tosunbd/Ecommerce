                ...
                <div className='bg-[#6f68d1] p-4 rounded-md'>
                    ...
                    <form onSubmit={submit}>
                        ...
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            ...
                            <input onChange={inputHandle} value={state.name} className='px-3 py-2 bg-transparent border rounded-md outline-none  border-slate-400' type="text" name='name' id='name' placeholder='Name' required />
                        </div>
                        ...
                        <div className='flex items-center w-full gap-3 mb-3'>
                            <input className='w-4 h-4 overflow-hidden text-blue-400' type="checkbox" name='cheeckbox' id='checkbox' />
                        ...
                        <div className='flex items-center justify-center gap-3'>
                            ...
                            <div className='w-[135%] h-[35px] flex rounded-md
                            bg-blue-700 shadow-lg hover:shadow-blue-700/50 justify-center
